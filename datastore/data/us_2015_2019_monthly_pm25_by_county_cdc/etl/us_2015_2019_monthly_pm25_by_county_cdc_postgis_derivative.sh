...
# us_2015_2019_monthly_pm25_by_county_cdc_postgis_derivative.sh
...
pg_dump -d $POSTGRES_DB -U $POSTGRES_USER -p $POSTGRES_PORT -h gaia-db -t us_2015_2019_monthly_pm25_by_county_cdc > derived/us_2015_2019_monthly_pm25_by_county_cdc.sql
