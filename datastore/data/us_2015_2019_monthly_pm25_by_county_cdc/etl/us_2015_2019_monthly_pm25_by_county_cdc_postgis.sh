...
# us_2015_2019_monthly_pm25_by_county_cdc_postgis.sh
...
ALTER SEQUENCE IF EXISTS us_2015_2019_monthly_pm25_by_county_cdc_ogc_fid_seq RENAME TO temp_ogc_fid_seq;
ALTER INDEX IF EXISTS us_2015_2019_monthly_pm25_by_county_cdc_geom_geom_idx RENAME TO temp_geom_idx;
ALTER TABLE IF EXISTS us_2015_2019_monthly_pm25_by_county_cdc RENAME CONSTRAINT us_2015_2019_monthly_pm25_by_county_cdc_pkey TO temp_pkey;
ALTER TABLE IF EXISTS us_2015_2019_monthly_pm25_by_county_cdc RENAME TO temp;
"

# Create copy of geom dependency
pg_dump -d $POSTGRES_DB -U $POSTGRES_USER -p $POSTGRES_PORT -h gaia-db -t us_2023_county_tl | sed 's/us_2023_county_tl/us_2015_2019_monthly_pm25_by_county_cdc/g' | psql -d $POSTGRES_DB -U $POSTGRES_USER -p $POSTGRES_PORT -h gaia-db 
