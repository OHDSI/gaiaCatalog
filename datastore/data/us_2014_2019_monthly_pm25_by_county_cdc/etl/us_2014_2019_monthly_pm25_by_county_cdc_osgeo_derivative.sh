...
# us_2014_2019_monthly_pm25_by_county_cdc_osgeo_derivative.sh
...
ogr2ogr -f GPKG -overwrite derived/us_2014_2019_monthly_pm25_by_county_cdc.gpkg PG:"dbname=$POSTGRES_DB port=$POSTGRES_PORT user=$POSTGRES_USER password=$POSTGRES_PASSWORD host='gaia-db'" -select "state_fips,countyfips,geoid,pm25_max_pred,pm25_med_pred,pm25_mean_pred,pm25_pop_pred,geom" us_2014_2019_monthly_pm25_by_county_cdc
