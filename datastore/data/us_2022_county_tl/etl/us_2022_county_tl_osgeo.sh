...
if [[ $do_update = 1 ]]; then
  ...
  attempts=0
  until (
    wget --retry-connrefused --waitretry=1 --read-timeout=20 --timeout=15 -t 10 -c -O download/us_2022_county_tl.zip 'ftp://ftp2.census.gov/geo/tiger/TIGER2022/COUNTY/tl_2022_us_county.zip' 2>&1
  ); do
    ((attempts++))
