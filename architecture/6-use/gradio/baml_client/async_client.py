...
class BamlAsyncClient:
    ...
    async def RAGWithCitations(
        self,
        question: str,context: str,
        baml_options: BamlCallOptions = {},
    ) -> types.ResponseWithCitations:
      ...
      return cast(types.ResponseWithCitations, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def RAGWithCitations(
        self,
        question: str,context: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.ResponseWithCitations, types.ResponseWithCitations]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.ResponseWithCitations, types.ResponseWithCitations](
        raw,
        lambda x: cast(partial_types.ResponseWithCitations, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.ResponseWithCitations, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
