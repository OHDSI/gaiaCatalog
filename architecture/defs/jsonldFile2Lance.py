...
def lchunkText(full_text: str = None, ):
    ...
    late_chunker = LateChunker(
        ...
        # options: jinaai/jina-embeddings-v2-small-en,  all-MiniLM-L6-v2
        # mode="sentence",
        chunk_size=512,
...
# TODO  allow flag for chunking type (late or semantic)
...
def processor(json_dir: str = None, db_path: str = None, table_name: str = None, ):
    ...
    # Clean up data types to ensure compatibility, Handle None values and ensure string types
    ...
    table = db.create_table(table_name, schema=DocVector.to_arrow_schema())
    ...
    try:
        ...
        print("Due to error, attempting to add data row by row...")
        ...
        # TODO check if this needs to be here as well as above
        # table.create_fts_index(["description"], replace=True, use_tantivy=True)
